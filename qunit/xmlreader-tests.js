...
test('a capon II', function() {
	var xmlobject = $($.parseXML('<?xml version="1.0" encoding ="utf-8"?><TicketAvailRS><ServiceTicket><TicketInfo xsi\\:type="ProductTicket">kk</TicketInfo></ServiceTicket></TicketAvailRS>'));
